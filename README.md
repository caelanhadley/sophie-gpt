...
Sophie is a chatbot that you can speak with and she will speak back! Using several APIs and through some custom prompting it is also possible for this chatbot to speak with varying tones and emotions. With it being possible for sophie to respond with multiple tones in each response.
